...
<Step number={3} title="Try it yourself">
  1. Save this file, and open a new one with the `.js` extension <br />
  2. by typing `log` you should see the vscode autocomplete suggestion for the snippet
  we just described
</Step>
...
in the meantime, you can take this quiz to test your knowledge ↓
