...
<AutoplayVideo src="/static/images/blog/vscode-custom-snippets/example.mov" />
...
<AutoplayVideo
  src="/static/images/blog/vscode-custom-snippets/default-value.mov"
  style={{ maxWidth: "70%" }}
/>
...
<AutoplayVideo
  src="/static/images/blog/vscode-custom-snippets/multiple-values.mov"
  style={{ maxWidth: "70%" }}
/>
