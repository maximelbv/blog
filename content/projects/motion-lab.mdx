...
image: /static/images/projects/motion-lab/thumbnail.svg
logo: /static/images/projects/motion-lab/logo.svg
index: []
...
<div className="relative default-layout aspect-video sm:rounded-lg overflow-hidden">
  <Image
    src="/static/images/projects/motion-lab/1.svg"
    alt="Homepage Design"
    fill
  />
</div>
...
Motion Lab is a personal project where I experiment with web animations and interactions. 
