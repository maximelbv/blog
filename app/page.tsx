    ...
    <div>
      ...
      >
        ...
        <div className="flex items-end">
          <div className="w-[210px] h-[210px] bg-secondary border-[1px] border-border rounded-[20px] -rotate-3 hover:rotate-0 mr-[-30px] transition-transform duration-500 ease-in-out">
            <PostInfos
              className=""
              variant="small"
            ...
            />
            <span>{nextToLastPost.title}</span>
              ...
              >
                <div className="flex flex-col gap-2">
                  <PostInfos
                    ...
                    date={lastPost.date}
                  />
                  <span className="font-dahlia text-[32px] font-bold">
                    {lastPost.title}
                  </span>
